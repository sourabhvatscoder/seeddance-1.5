...
return [
    ...
    */
    ...
    'seedance' => [
        ...
        'base_url' => env('SEEDANCE_BASE_URL', 'https://ark.ap-southeast.bytepluses.com/api'),
        'generate_video_path' => env('SEEDANCE_GENERATE_VIDEO_PATH', '/v3/contents/generations/tasks'),
